...
## Project Structure
    ...
    ├── sparkling_wood_31250  # Django project configurations
...
1. Clone this repo and `cd sparkling_wood_31250`
...
2. Clone this repo and `cd sparkling_wood_31250`
